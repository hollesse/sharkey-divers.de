...
- [ ] Pinning-/Update-Policy ist Teil des ADRs (kein separates ADR nötig).
- [ ] Keine Code-Änderung nötig — die Workflow-Datei selbst entsteht im Walking Skeleton ([[infrastructure-001-walking-skeleton]]).
