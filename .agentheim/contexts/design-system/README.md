...
- ~~Logo fehlt~~ **Gelöst (2026-08-31):** Der Betreiber hat das Original-Logo geliefert. Es liegt in voller Auflösung als Referenz unter `docs/design-prototype/assets/logo.png` und verkleinert (693×320, ~62 KB) unter `assets/img/logo.png`; Header (88px) und Footer (110px, invertiert auf dunklem Grund, wie im Prototyp) nutzen es. Die SVG-Platzhalter wurden entfernt.
